...
<script type="text/javascript" src="<c:url value='/js/ems/seg/kakaoTemplateUpdateP.js'/>"></script>
				...
				<div class="manage-wrap">
					...
					<form id="kakaoTemplateInfoForm" name="kakaoTemplateInfoForm" method="post">
						...
						<fieldset>
							...
							<!-- btn-wrap// -->
							<div class="btn-wrap">
								<button type="button" class="btn big fullblue" onclick="goKakaoTemplateUpdate();">수정</button>
