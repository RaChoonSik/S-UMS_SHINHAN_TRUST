...
<script type="text/javascript" src="<c:url value='/js/ems/seg/smsTemplateAddP.js'/>"></script>
									...
									<ul>
										<li>
											...
											<div class="list-item">
												...
												<button type="button" class="btn fullblue" id="checkTempCd" onclick="checkSmsTempCd()" value="N">중복확인</button>
											</div>
										</li>
										<li>
