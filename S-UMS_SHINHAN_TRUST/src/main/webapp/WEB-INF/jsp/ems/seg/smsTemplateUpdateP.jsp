...
<script type="text/javascript" src="<c:url value='/js/ems/seg/smsTemplateUpdateP.js'/>"></script>
<body>
				...
				<div class="manage-wrap">
					...
					<form id="smsTemplateInfoForm" name="smsTemplateInfoForm" method="post">
						...
						<fieldset>
									...
									<ul>
										...
										<li>
											...
											<div class="list-item">
												...
												<button type="button" class="btn fullblue" onclick="popCampSelect();">선택</button>
											</div>
										</li>
										-->
									</ul>
							...
							<!-- btn-wrap// -->
							<div class="btn-wrap">
								<button type="button" class="btn big fullblue <c:if test="${'002' eq smsTemplateInfo.status}">hide</c:if>" onclick="goUpdate();">수정</button>
	...
	<!-- 수신자그룹선택 팝업// -->
	<%@ include file="/WEB-INF/jsp/ems/seg/pop/pop_segment.jsp"%>
	<!-- //수신자그룹선택 팝업 -->
	...
	<!-- 캠페인선택 팝업// -->
	<%@ include file="/WEB-INF/jsp/ems/seg/pop/pop_campaign.jsp" %>
	<!-- //캠페인선택 팝업 -->
