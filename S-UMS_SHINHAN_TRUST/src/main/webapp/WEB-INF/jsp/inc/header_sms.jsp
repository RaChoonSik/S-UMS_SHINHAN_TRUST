...
<meta name="Author" content="sict">
<meta name="keywords" content="UMS">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>S-UMS | 문자발송</title>
...
<link rel="stylesheet" href="<c:url value='/css/style_sms.css'/>">
...
<script type="text/javascript" src="<c:url value='/js/sms.js'/>"></script>
